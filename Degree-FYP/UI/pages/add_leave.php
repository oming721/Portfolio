...
include("function/leave_func.php");
?>
<html lang="en">
				...
				<div class="col-md-12 grid-margin">
				  <div class="row">
					<div class="col-12 col-xl-8 mb-4 mb-xl-0">
					  <h3 class="font-weight-bold">Add Leaves</h3>
					</div>
				  </div>
				</div>
			  </div>
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            ...
            <form class="form-sample" method="post">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="Optional" name="inputReason" id="inputReason">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <input type="submit" class="add btn btn-primary" name="addleave" id="addleave" value="ADD">
                  </form>
