...
include("function/company_profile_func.php");
?>
<html lang="en">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="profile-img">
                          <img src="<?php echo "images/company/company.png";?>" style="border-radius: 50%;">
                        </div>
                      </div>
                      <div class="col-md-6">
                          ...
                          <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input type="text" name="inputLocation" id="inputLocation" value="<?php echo "$location";?>" readonly size="35" class="form-control"><p></p>
                                </div>
                              </div>
                              <?php
