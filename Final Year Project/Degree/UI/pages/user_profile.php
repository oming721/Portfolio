...
include("function/user_profile_func.php");
?>
<html lang="en">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="profile-img">
                          <img src="<?php echo "images/$email/profile/profile.png";?>" style="border-radius: 50%;">
                        </div>
                      </div>
                      <div class="col-md-6">
                      ...
                      <div class="col-md-2">
                      <?php if(isset($_GET['more_detail']) && $pst != '4')
                      {
                          ...
                          <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input type="date" name="inputBirthday" id="inputBirthday" value="<?php echo "$birthday";?>" readonly size="35" class="form-control"><p></p>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input type="text" name="inputPhone" id="inputPhone" value="<?php echo "$phone";?>" readonly size="35" class="form-control"><p></p>
                                </div>
                              </div>
                              ...
                              <div class="col-md-8">
                                <input type="text" name="inputAddress" id="inputAddress" value="<?php echo "$address"?>" readonly size="35" class="form-control"><p></p>
                              </div> 
                              <?php
                              if(isset($_GET['more_detail']) && isset($_GET['user_id']))
                              {
                               $detail = $_GET['more_detail'];
