...
include("function/edit_user_func.php");
?>
<html lang="en">
...
<body>
            ...
            <div class="card-body">
              <section>
                <div class="container emp-profile">
                  <form method="post" enctype="multipart/form-data" onsubmit="return form_onSubmit(this)">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="profile-img">
                          <img src="<?php echo "images/$email/profile/profile.png";?>" style="border-radius: 50%;" id="profileImage">
                        </div>
                        <input id="imageUpload" type="file" name="imageUpload" placeholder="Photo" accept="image/png" capture>
                      </div>
                          ...
                          <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                              ...
                              <div class="col-md-8">
                                  ...
                                  if($self_position == '4')
                                  {
                                    echo "<select class='form-control' id='inputGender' name='inputGender'>";
                                    if($acc['user_gender'] == 'Male')
                                    {
                                  ...
                                  {
                                  ?>
                                    <input type="text" name="inputGender" id="inputGender" value="<?php echo "$gender";?>" readonly size="35" class="form-control"><p></p>
                                  <?php
                                  }
                                  ?>
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    if($self_position == '4')
                                    {
                                      echo "<select class='form-control' id='inputCompany' name='inputCompany'>";
                                      if($company == 'Pending')
                                      {
                                        echo "<option value='NULL' selected>Pending</option>";
                                      }
                                      else
                                      {
                                        echo "<option value='NULL'>Pending</option>";
                                      }
                                      while($row=mysqli_fetch_assoc($result))
                                      {
                                        $comp_name = $row['comp_name'];
                                        $comp_id = $row['comp_id'];
                                        if($acc['user_company'] == $row['comp_id'])
                                        {
                                    ...
                                    {
                                    ?>
                                      <input type="text" name="inputCompany" id="inputCompany" value="<?php echo "$company";?>" readonly size="35" class="form-control"><p></p>
                                    <?php
                                    }
                                    ?>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    if($self_position == '4')
                                    {
                                      ...
                                      else if($position == 'HR')
                                      {
                                        echo "<option value='0'>Pending</option>";
                                        echo "<option value='2'>Employee</option>";
                                        echo "<option value='3' selected>HR</option>";
                                        echo "<option value='4'>Admin</option>";
                                      }
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  ...
                                  {
                                  ?>
                                    <input type="date" name="inputBirthday" id="inputBirthday" value="<?php echo "$birthday";?>" onchange="confirm_birthday(this.value)" size="35" class="form-control" required><p></p><p></p>
                                  <?php
                                  }
                                  else
                                  {
                                  ?>
                                    <input type="date" name="inputBirthday" id="inputBirthday" value="<?php echo "$birthday";?>" readonly size="35" class="form-control"><p></p><p></p>
                                  <?php
                                  }
                                  ?>
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input type="text" name="inputPhone" id="inputPhone" value="<?php echo "$phone";?>" onchange="confirm_phone(this.value)" size="35" class="form-control" required><p></p>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <input type="text" name="inputAddress" id="inputAddress" value="<?php echo "$address"?>" onchange="confirm_address(this.value)"  size="35" class="form-control" required><p></p>
                                </div>
                              </div>
                              <?php
  ...
  <script src="function/edit_user_func.js"></script>
