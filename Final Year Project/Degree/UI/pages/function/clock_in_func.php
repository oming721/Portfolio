...
if(isset($_POST['btn_submit']))
{
  ...
  if($count==0)
  {
    mysqli_query($connect,"INSERT INTO attendance(att_date, att_clock_in, att_user) VALUES ('$todaydate', '$time', '$user')");
  }
  else
  {
    mysqli_query($connect,"UPDATE attendance SET att_clock_in = '$time' WHERE att_date = '$todaydate' AND att_user = '$user'");
  }
