               ...
               <div class="page-box">
                  <div class="table-responsive">
                     <table id="product-order" class="table table-hover">
                        ...
                        <?php
                           $result = mysqli_query($connect,"SELECT * FROM $bas.court WHERE court_isDelete ='0' AND court_status = 'DISABLE' ");
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td><button class="btn btn-danger" class="confirm" onclick="confirm('<?php echo $row['court_id']; ?>')"><i class="fa fa-trash-o">Delete</i></button></td>
                           </tr>
                        </tbody>
...
{
  $id = $_GET['id'];
  $result=mysqli_query($connect,"SELECT * FROM court WHERE court_id = '$id'");
  ...
  else
  {
   ...
   mysqli_query($connect,"UPDATE $bas.court SET court_isDelete = '1' WHERE court_id = '$id'");
  mysqli_query($connect,"DELETE FROM $bas.court WHERE court_isDelete ='1'");
