                  ...
                  <div class="row">
                     <div class="col-md-12 col-sm-12">
                        <div class="add-product-form-group">
                           ...
                           <div class="row">
                              <div class="col-md-12">                  
                                 <img src="profile_picture/<?php echo $row['staff_image']; ?>" style="width:100px; height: 100px; border-radius: 90px;" id="output"/>

                                 <p>
                                    <br><?php echo "<label>Staff Name</label>";  
                                 ...
                                 <br><a href="view_all_staff.php" class="btn btn-success" >
