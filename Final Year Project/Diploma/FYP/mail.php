...
if($_POST)
{
  ...
  if($email!='')
  {
    ...
    if($count > 0)
    {
      $url = "http://".$_SERVER["HTTP_HOST"].dirname($_SERVER["PHP_SELF"])."/sign_in.php";
      $to = $_POST['email'];
      $subject = $_POST['subject'];
      $body = $_POST['message']."Click <a href='$url'>this link</a> to log in.";
    ...
    {
      $message="<div class='error'>Email Not Send</div>";
    }
}
            ...
            <div class="widget_card_body collapse in" id="mail_home">
               <div class="mail-editor">
                  ...
                  <form method="POST">
                    <?php echo $message; ?>
                     <p>
                        <input type="email" placeholder="To" name="email" id="email">
                     </p>
