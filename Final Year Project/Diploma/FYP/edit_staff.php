            ...
            <div class="row">
              <div class="col-md-12 col-sm-12">
                <div class="add-product-form-group">
                  ...
                  <form action="edit_staff_advance.php" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?=$id?>">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <img style="width:100px; height: 100px; border-radius: 50px;" id="output" src="profile_picture/<?php echo $row['staff_image']; ?>" readonly>
                          <script>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <p>
                            ...
                            <input type="text" name="phone_number" value="<?php echo $row['staff_phone_number']; ?>" readonly>
                          </p>
                          ...
                          <p>
                            <label>Level</label>
                            <br><select name="staff_level">
                              <option value="<?php echo $row['level'];?>">Admin</option>
                              <option value="<?php echo $row['level'];?>">Staff</option>
                            </select>
                          </p>
                          <div class="row">
                            <div class="col-md-12">
